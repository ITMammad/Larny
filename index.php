<?php
    include(__DIR__ . "/assets/php/Larny.php");
...
<html dir="ltr" lang="en">
    <head>
        ...
        <title>Larny app</title>
        <link rel="apple-touch-icon" href="<?php echo $server; ?>/assets/img/logo.png" />
        <link rel="icon" href="<?php echo $server; ?>/assets/img/logo.png" />
        <meta name="description" content="A new Larany application powered by Larany framework in php programming language..." />
    ...
    <body>
        ...
        <div class="Larny">
            <?php
                Larny::registerRootElement(".Larny");
                Larny::Router()::get("/" , function() {
                    include(__DIR__ . "/assets/pages/index.php");
                });
                Larny::Router()::registerNotFoundPage(function() {
